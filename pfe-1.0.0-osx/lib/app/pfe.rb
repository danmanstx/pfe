...
@user = ARGF.argv[3] || 'postgresql'
@function_directory = ARGF.argv[4] || '/tmp/postgresFunctions'
@action = ARGF.argv[5] || 'save'

@file = ARGF.argv[6].gsub(' ', '\\ ') unless ARGF.argv[6].nil?
  ...
  time do
    ...
    schemas.each do |schema|
      ...
      functions.each do |function|
        ...
        function_file_name = function['name'] + ".#{file_type}"
